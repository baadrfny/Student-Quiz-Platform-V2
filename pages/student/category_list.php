...
<body class="bg-gray-50 min-h-screen">
  ...
  <main class="max-w-7xl mx-auto px-4 py-10">
    ...
    <div class="flex flex-col md:flex-row gap-4 mb-8">
      ...
      <!-- <select class="px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-indigo-500">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <?php else: ?>
        ...
        <?php foreach ($categories as $categorie): ?>
          <div class="quizCards bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition hover:-translate-y-1">
            <div class="h-2 bg-gradient-to-r from-blue-500 to-indigo-600"></div>

            <div class="p-6">
              <h3 class="quiz-title text-xl font-bold text-gray-800 mb-3">
              ...
              <p class="text-gray-600 mb-4 text-sm">
                <?php
                $description = $categorie['description'] ?? 'Testez vos connaissances';
                echo htmlspecialchars($categorie['description']);
              ...
              <div class="flex items-center text-sm text-gray-500 mb-6">
                ...
                <span>
                  <?php echo htmlspecialchars($categorie['created_at']); ?>
                </span>
              </div>
